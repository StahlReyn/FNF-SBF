...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('sbf_lovesick'));
		...
		gfDance = new FlxSprite(FlxG.width * 0.6, FlxG.height * 0.1);
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 10:
				addMoreText('Coalmunist');
			case 11:
				addMoreText('or Stahl');
			case 12:
				deleteCoolText();
			case 13:
				addMoreText('Friday');
